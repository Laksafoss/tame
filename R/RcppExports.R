...
rcpp_sum_of_minima_triangle <- function(n, m, row_index, col_index, inner_terms) {
  .Call(`_tame_rcpp_sum_of_minima_triangle`, n, row_index, inner_terms)
}
...
rcpp_double_sum_triangle <- function(n, m, row_index, col_index, inner_terms) {
  .Call(`_tame_rcpp_double_sum_triangle`, n, row_index, inner_terms)
}
