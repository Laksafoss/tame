...
#'
#' @param x An object of class \code{summary.medic}.
...
#'
#' This function provides a summary of an object by using the \code{str} 
#' function. It is a modified version of the \code{str.default} function from 
#' the \code{utils} package, with the maximum level set to 2.
